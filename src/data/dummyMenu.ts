export const menuList = [
  ...
  {id: '335', pid: '3', url: '', component: '', order: 2, depth: 2, name: '역사 통계', description: ''},
  {
    ...
    component: 'CongestionStationStatistics',
    order: 1,
    depth: 3,
    name: '역사 통계 조회',
    description: ''
  },
  {
    id: '3336',
    pid: '335',
    url: '/congestion-statistics/area/statistics',
  ...
  {id: '340', pid: '3', url: '', component: '', order: 4, depth: 2, name: '장비모니터링', description: ''},

  {
    id: '341',
    pid: '340',
    url: '/congestion-statistics/equipment/equip-status',
    component: 'CongestionEquipmentStatus',
    order: 1,
    depth: 3,
    name: '장비상태',
    description: ''
  },
  {
    id: '342',
    pid: '340',
    url: '/congestion-statistics/equipment/amount-use',
    component: 'CongestionAmountUse',
    order: 2,
    depth: 3,
    name: '사용량조회',
    description: ''
